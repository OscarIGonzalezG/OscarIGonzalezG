...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=6AD3F7&center=true&vCenter=true&random=false&width=800&lines=Ingeniero+en+Informática+💻;Full+Stack+Developer+🚀;Angular+|+NestJS+|+Spring+Boot;Building+SaaS+Solutions+🎯" alt="Typing SVG" />
</div>
...
```ts
const oscar = {
  rol: "Ingeniero en Informática | Full Stack Developer",
  ubicacion: "Chile 📍",
  stack_principal: {
  ...
  enfoque: "Aprendizaje continuo mediante proyectos Full Stack reales"
};
```
...
<div align="center">
<img src="https://skillicons.dev/icons?i=angular,ts,tailwind,nestjs,nodejs,java,spring,postgres,docker,git,github&theme=dark" />
</div>
